...
* A anotação celular deve incluir:
  ...
  * Uma **tabela clara dos marcadores utilizados** por cluster.
...
* Indique o método utilizado (CellChat, CellPhoneDB, NicheNet, etc.).
...
* Indique a ferramenta usada (Monocle, Slingshot, PAGA).
